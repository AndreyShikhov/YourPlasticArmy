    ...
    : super(
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({factionId = false, codexesRefs = false, unitsRefs = false}) {
                return PrefetchHooks(
                  db: db,
...
typedef $$ArmiesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (Army, $$ArmiesTableReferences),
      Army,
      PrefetchHooks Function({bool factionId, bool codexesRefs, bool unitsRefs})
    >;
...
class $$CodexesTableTableManager
    extends
        RootTableManager<
          ...
          Codexe,
          PrefetchHooks Function({bool armyId, bool codexDetachmentsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({armyId = false, codexDetachmentsRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
...
class $$DetachmentsTableTableManager
    extends
        RootTableManager<
          ...
          DetachmentRow,
          PrefetchHooks Function({bool codexDetachmentsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({codexDetachmentsRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
                if (codexDetachmentsRefs) db.codexDetachments,
