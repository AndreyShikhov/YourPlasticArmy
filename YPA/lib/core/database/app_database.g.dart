...
class Faction extends DataClass implements Insertable<Faction> {
  ...
  Faction copyWith({String? id, String? code, String? name}) => Faction(
    id: id ?? this.id,
    code: code ?? this.code,
    name: name ?? this.name,
  );
...
class $UnitsTable extends Units with TableInfo<$UnitsTable, UnitRow> {
  ...
  UnitRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return UnitRow(
      ...
      unitStats: $UnitsTable.$converterunitStats.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}unit_stats'],
        )!,
      ),
    );
  }
...
class UnitRow extends DataClass implements Insertable<UnitRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['unit_stats'] = Variable<String>(
        $UnitsTable.$converterunitStats.toSql(unitStats),
      );
    }
    return map;
  }
  ...
  UnitRow copyWithCompanion(UnitsCompanion data) {
    return UnitRow(
      ...
      unitStats: data.unitStats.present ? data.unitStats.value : this.unitStats,
    );
  }
  ...
  @override
  int get hashCode =>
      Object.hash(id, name, armyId, codexId, roleCode, unitStats);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is UnitRow &&
          ...
          other.unitStats == this.unitStats);
}
...
class UnitsCompanion extends UpdateCompanion<UnitRow> {
  ...
  const UnitsCompanion({
    ...
    this.unitStats = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  ...
  static Insertable<UnitRow> custom({
    ...
    return RawValuesInsertable({
      ...
      if (unitStats != null) 'unit_stats': unitStats,
      if (rowid != null) 'rowid': rowid,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (unitStats.present) {
      map['unit_stats'] = Variable<String>(
        $UnitsTable.$converterunitStats.toSql(unitStats.value),
      );
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
...
class RoleData extends DataClass implements Insertable<RoleData> {
  ...
  RoleData copyWith({String? id, String? code, String? name}) => RoleData(
    id: id ?? this.id,
    code: code ?? this.code,
    name: name ?? this.name,
  );
...
final class $$FactionsTableReferences
  ...
  _userArmiesRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.userArmies,
    aliasName: $_aliasNameGenerator(db.factions.id, db.userArmies.factionId),
  );
...
class $$FactionsTableTableManager
    extends
        RootTableManager<
          ...
          Faction,
          PrefetchHooks Function({bool armiesRefs, bool userArmiesRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({armiesRefs = false, userArmiesRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (armiesRefs) db.armies,
...
class $$UnitsTableOrderingComposer
  ...
  ColumnOrderings<String> get unitStats => $composableBuilder(
    column: $table.unitStats,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$UnitsTableTableManager
    extends
        RootTableManager<
          ...
          UnitRow,
          PrefetchHooks Function({bool armyId, bool codexId})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({armyId = false, codexId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
...
class $$RoleTableTableManager
    extends
        RootTableManager<
          ...
          (RoleData, BaseReferences<_$AppDatabase, $RoleTable, RoleData>),
          RoleData,
          PrefetchHooks Function()
        > {
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> name = const Value.absent(),
                Value<int> rowid = const Value.absent(),
              }) => RoleCompanion(id: id, code: code, name: name, rowid: rowid),
          createCompanionCallback:
              ({
                required String id,
                required String code,
...
final class $$UserArmiesTableReferences
  ...
  static $FactionsTable _factionIdTable(_$AppDatabase db) =>
      db.factions.createAlias(
        $_aliasNameGenerator(db.userArmies.factionId, db.factions.id),
      );
