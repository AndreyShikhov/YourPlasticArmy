...
List<WeaponAbilitySeed> allWeaponAbilities()
{
    return [
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.assault).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.rapidFire).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.ignoresCover).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.twinLinked).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.pistol).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.torrent).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.lethalHits).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.lance).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.indirectFire).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.blast).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.precision).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.melta).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.heavy).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.hazardous).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.sustainedHits).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.extraAttacks).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.devastatingWounds).code,
        ...
        WeaponAbilitySeed(
            code: WeaponAbilitiesCodeX(WeaponAbilitiesCode.anti).code,
