...
class AddUnitToUserRoster
{
    ...
    }) async
    {
        ...
        if (army != null && unit != null) 
        {
            ...
            final updatedArmy = await army.addUnitToUserArmy(unitId, instanceId, unit.role.value.name, unit.unitComposition, unit.selectedWargearIndices, unit.weaponSnapshot, unit.characteristics);
